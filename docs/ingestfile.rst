...
Assuming that you still have the airflow-etl-playbook project cloned somewhere (see `Documentation Github Project <https://github.com/Pravalika20007/airflow-etl-playbook/>`_), 
